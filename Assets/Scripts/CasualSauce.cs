...
public class CasualSauce : MonoBehaviour
{
    ...
    public void MiniAppreciate() // When player reaches checkpoint or small victory.
    {
        ...
        apprMiniAnim.gameObject.SetActive(false); // since animations are played on start, simply making sure it's off before it's turned on.
